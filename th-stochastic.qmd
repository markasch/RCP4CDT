...
1. The mean-variance model, $$ \rho(Z) = \mathrm{E}_(Z) - \kappa \mathrm{Var} (Z) . $$
2. The value-at-risk (VaR),   $$\rho(Z) = \mathrm{E}_(Z) - \kappa \mathrm{VaR}_{\alpha} (Z),$$ where $$\mathrm{VaR}_{\alpha} (Z) = \inf \{ t \colon   \mathrm{P}(Z \le t ) \ge \alpha \} .$$
