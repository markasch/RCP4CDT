...
As presented in the [Risk Measures](./th-stochastic.qmd#risk-measures) section, there are various ways to include risk in the cost function. In this [example](./examples/S3-OPF_risk.ipynb), we analyze a stochastic  energy dispatch problem, and compare the following risk measures:
