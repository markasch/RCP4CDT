# Using PYOMO {.unnumbered}


This section details all the practical aspects of the optimal CCDS scheduling. We intentionally provide a very general framework, but illustrate it with several simple examples.
...
## Disjunctions {#sec-disj}

The decisions encountered in the CCDS involve discrete, Boolean choices. These can take the following forms:
...
1. to have as few as possible big-M constraints with the large constants $M,$ 
2. to avoid having superfluous decision variables, and 
3. to avoid formulating as an inequality, a relation that should hold with equality for the optimal solution.
