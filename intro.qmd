...
A digital model is a virtual representation of a physical object, system, or process. It can have
...
A digital shadow is an evolving digital representation that mirrors the current state and
...
We conclude that this is the concept most suited to the Digital Continuum.

### Digital Twins

Digital twins integrate the virtual and physical realms by creating a real-time connection
...
## CDT: Continuum Digital Twin or Shadow
...
The core of the CDT is a set of three modules: simulation, scheduling and optimization, as shown in @fig-modules. 
